...
<head>
    ...
    <link href="<?php echo $this->view_dir;?>sbadmin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo $this->view_dir;?>sbadmin/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card">
                <img class="sidebar-card-illustration mb-2" src="<?php echo $this->view_dir;?>sbadmin/img/undraw_rocket.svg" alt="">
                <p class="text-center mb-2"><strong>SB Admin Pro</strong> is packed with premium features, components, and more!</p>
                <a class="btn btn-success btn-sm" href="<?php echo $this->Html->safe($this->base_uri);?>">Upgrade to Pro!</a>
            </div>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->view_dir;?>sbadmin/img/undraw_profile_1.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->view_dir;?>sbadmin/img/undraw_profile_2.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->view_dir;?>sbadmin/img/undraw_profile_3.svg"
                                            alt="">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo $this->view_dir;?>sbadmin/img/undraw_profile.svg">
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo $this->view_dir;?>sbadmin/img/undraw_posting_photo.svg" alt="">
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Powered by <a href="http://www.blesta.com/">Blesta</a>, &copy; Phillips Data, Inc.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
